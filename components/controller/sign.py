...
def obtener_dimensiones(pdf_base64, num_pagina=0):
...
def firmar(signature, pdf_base64, position):
    contraseña = "Sq1234%."
    ...
    # Ejemplo de uso
    ancho, altura = obtener_dimensiones(pdf_base64)

    y = float(altura) - position["y"] - 50

    # Contenido del texto que deseas agregar
    firma_texto = f"""Firmado Digitalmente por:
    Nombre: {signature['name']}
    Correo: Luis@gmail.com
    Teléfono: +573124568759
    Documen: CC. 12345678
    IP: 127.0.0.1
    Huella-identidad: fab4361c-b866-4a40-9502-089d179a
    Fecha: {date_str}"""
    ...
    dct = {
            ...
            "sigpage": page,
            "sigbutton": True,
            "sigfield": signature['name'],
            # "auto_sigfield": False,
            # "sigandcertify": False,
            "signaturebox": (
            position["x"],  # Usa la posición x proporcionada
                y,  # Usa la posición y proporcionada
                position["x"] + 190,  # Añade un ancho de 250 unidades a x
                y + 60   # Añade una altura de 100 unidades a y
            ),  
            ...
            "signature_manual": [
                ...
                ['image', 'sig0', 2, 2, 58, 58,  False, False],
                ...
                ['text_box', firma_texto,
                    ...
                    'default', 60, 0, 195, 60, 6, True, 'left', 'top'],
                ],
